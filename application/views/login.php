...
<html lang="en">
  <head>
    ...
    <link href="<?php echo base_url().'resources' ?>/lib/Ionicons/css/ionicons.css" rel="stylesheet">
    <link href="<?php echo base_url().'resources' ?>/lib/perfect-scrollbar/css/perfect-scrollbar.css" rel="stylesheet">

    <!-- Katniss CSS -->
    <link rel="stylesheet" href="<?php echo base_url().'resources' ?>/css/katniss.css">
  </head>
...
<form action="<?php echo base_url().'login/checkAuth' ?>">
    ...
    <script src="<?php echo base_url().'resources' ?>/lib/jquery/jquery.js"></script>
    <script src="<?php echo base_url().'resources' ?>/lib/popper.js/popper.js"></script>
    <script src="<?php echo base_url().'resources' ?>/lib/bootstrap/bootstrap.js"></script>
  </body>
</html>
